...
Broid allows you to connect your application/bot to multiple IRC channels.
...
[![CLA assistant](https://cla-assistant.io/readme/badge/broidhq/broid-irc)](https://cla-assistant.io/broidhq/integrations)

**Feedback or features request are welcome. Go to https://github.com/broidhq/integrations**
...
```javascript
import broidIRC from 'broid-irc'
...
sharing your feedback on our [Integratons GitHub Repo](https://github.com/broidhq/integrations) and let's build Broid together!
